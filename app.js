 ...
 var UIcontroller = (function() {
    ...
    var formatNumber = function(num, type) {
         ...
         */
         ...
         int = numSplit[0];
         if(int.length > 3) {
             int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, int.length); //if th einput is 2310, o/p:2,310
    ...
    return{
        ...
        displayMonth: function() {
            ...
            now = new Date();
            //var christmas = new Date(2016, 11, 255);
            months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'october', 'November', 'Decmber'];
            month = now.getMonth();
...
//GLOBAL APP CONTRLLER
  var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updatePercentages = function() {
        ...
        //3. update tthe UI with the new message
